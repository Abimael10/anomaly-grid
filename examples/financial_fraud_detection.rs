...
//!
//! This example demonstrates real-time financial fraud detection using the anomaly-grid
//! library. It shows how to detect various types of financial fraud including credit card
//! fraud, money laundering, and suspicious transaction patterns.
