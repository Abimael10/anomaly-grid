...
pub fn analyze_training_data_characteristics(sequence: &[String]) -> TrainingDataAnalysis {
    ...
    TrainingDataAnalysis {
        ...
        entropy,
        normalized_entropy,
        most_common_element: element_counts.iter()
...
impl TrainingDataAnalysis {
    ...
    pub fn recommendations(&self) -> Vec<String> {
        ...
        if self.total_elements < 100 {
            recommendations.push("Consider using more training data for better model quality".to_string());
        }
